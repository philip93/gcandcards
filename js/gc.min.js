...
var Place = (function() {
    ...
    var data = new Array (
        ...
        new Array(6, new Array("desert")),           // Deadmoon Desert
        //new Array(7, new Array("desert_night")),     // Deadmoon Desert (Night)
        new Array(7, new Array("ocean")),            // Cerulean Deep
        //new Array(9, new Array("ocean_night")),      // Cerulean Deep (Night)
        //new Array(12, new Array("golbez")),          // Grab-a-Golbez Campaign
		new Array(8, new Array("invitation")),      // Invitation Bonus
        new Array(9, new Array("coliseum")),        // Coliseum Rewards
        new Array(10, new Array("fp")),              // Friend Points
        new Array(11, new Array("trials")),          // Hall of Trials
        new Array(12, new Array("trials2")),         // Hall of Trials II
        //new Array(6, new Array("gold_slime")),      // Special Gold Present
        new Array(13, new Array("others")),          // Other Bonus
        //new Array(19, new Array("login")),           // Login Rewards
        new Array(14, new Array("grounds")),         // All Hunting Grounds
		new Array(15, new Array("deadman")),		//Deadman's cross-over
...
var Skill = (function() {
    ...
    var data = new Array (
        ...
        new Array(12, 0, "fire4x",      0, 1300, 1, 0, 0, 0, 0, 0, 0, Attribute.fire, 5),    // Meteor Swarm (Fire +4x)
        new Array(13, 0, "water1",      0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.water, 1), // Aqua Splash
        new Array(14, 0, "water2",      0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.water, 2), // Aqua Shot
        new Array(15, 0, "water3",      0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.water, 3), // Aqua Burst
        new Array(16, 0, "water4",      0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.water, 4), // Maelstrom
        new Array(17, 0, "earth1",      0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.earth, 1), // Ice Needle
        new Array(18, 0, "earth2",      0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.earth, 2), // Ice Spike
        new Array(19, 0, "earth3",      0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.earth, 3), // Rock Bite
        new Array(20, 0, "earth4",      0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.earth, 4), // Earthquake
        new Array(21, 0, "lightning1",  0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.lightning, 1), // Thunderbolt
        new Array(22, 0, "lightning2",  0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.lightning, 2), // Thunder Strike
        new Array(23, 0, "lightning3",  0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.lightning, 3), // Call Lightning
        new Array(24, 0, "lightning4",  0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.lightning, 4), // Chain Lightning
        new Array(25, 0, "wind1",       0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.wind, 1), // Wind Cutter
        new Array(26, 0, "wind2",       0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.wind, 2), // Wind Edge
        new Array(27, 0, "wind3",       0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.wind, 3), // Whirlwind
        new Array(28, 0, "wind4",       0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.wind, 4), // Tornado
        new Array(29, 0, "poison1",     0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.poison, 1), // Poison Bubble
        new Array(30, 0, "poison2",     0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.poison, 2), // Poison Mist
        new Array(31, 0, "poison3",     0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.poison, 3), // Poison Field
        new Array(32, 0, "poison4",     0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.poison, 4), // Venom Riot
        new Array(33, 0, "death1",      0,  150, 0, 0, 0, 0, 0, 0, 0, Attribute.death, 1), // Gaze of Death
        new Array(34, 0, "death2",      0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.death, 2), // Touch of Death
        new Array(35, 0, "death3",      0,  600, 0, 0, 0, 0, 0, 0, 0, Attribute.death, 3), // Embrace of Death
        new Array(36, 0, "death4",      0, 1200, 0, 0, 0, 0, 0, 0, 0, Attribute.death, 4), // Kiss of Death
        new Array(37, 0, "light1",      0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.light, 1), // Holy Light
        new Array(38, 0, "light2",      0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.light, 2), // Shine Smite
        new Array(39, 0, "light3",      0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.light, 3), // Shine Burst
        new Array(40, 0, "light4",      0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.light, 4), // Vanish
        new Array(41, 0, "darkness1",   0,  150, 1, 0, 0, 0, 0, 0, 0, Attribute.darkness, 1), // Darkness
        new Array(42, 0, "darkness2",   0,  300, 1, 0, 0, 0, 0, 0, 0, Attribute.darkness, 2), // Dark Pain
        new Array(43, 0, "darkness3",   0,  600, 1, 0, 0, 0, 0, 0, 0, Attribute.darkness, 3), // Dark Psalm
        new Array(44, 0, "darkness4",   0, 1200, 1, 0, 0, 0, 0, 0, 0, Attribute.darkness, 4), // Nightmare
        new Array(45, 1, "atk10",       0,  100, 0, 0, 0,  0.1, 0, 0, 0, Attribute.none, 0), // Might
        new Array(46, 1, "atk20",       0,  200, 0, 0, 0,  0.2, 0, 0, 0, Attribute.none, 0), // Greater Might
        new Array(47, 1, "atk25",       0,  locale.getLanguage() == LANG_JP ? 600 : 400, 0, 0, 0, 0.25, 0, 0, 0, Attribute.none, 0), // Fount of Strength
        new Array(48, 1, "def10",       0,  100, 0, 0, 0, 0,  0.1, 0, 0, Attribute.none, 0), // Protect
        new Array(49, 1, "def20",       0,  200, 0, 0, 0, 0,  0.2, 0, 0, Attribute.none, 0), // Greater Protect
        new Array(50, 1, "def25",       0,  locale.getLanguage() == LANG_JP ? 600 : 400, 0, 0, 0, 0, 0.25, 0, 0, Attribute.none, 0), // Stoic Stance
        new Array(51, 1, "def40",       0,  1000, 0, 0, 0, 0, 0.4, 0, 0, Attribute.none, 0), // Ultimate Guard
        new Array(52, 1, "agi10",       0,  100, 0, 0, 0, 0, 0,  0.1, 0, Attribute.none, 0), // Haste
        new Array(53, 1, "agi20",       0,  200, 0, 0, 0, 0, 0,  0.2, 0, Attribute.none, 0), // Greater Haste
        new Array(54, 1, "agi25",       0,  locale.getLanguage() == LANG_JP ? 600 : 400, 0, 0, 0, 0, 0, 0.25, 0, Attribute.none, 0), // Quickstride
        new Array(55, 1, "wis10",       0,  100, 0, 0, 0, 0, 0, 0,  0.1, Attribute.none, 0), // Cunning
        new Array(56, 1, "wis20",       0,  200, 0, 0, 0, 0, 0, 0,  0.2, Attribute.none, 0), // Greater Cunning
        new Array(57, 1, "wis25",       0,  locale.getLanguage() == LANG_JP ? 600 : 400, 0, 0, 0, 0, 0, 0, 0.25, Attribute.none, 0), // Mental Geyser
        new Array(58, 1, "atkdef10",    0,  400, 0, 0, 0, 0.1, 0.1,   0,   0, Attribute.none, 0), // Ursince Aspect
        new Array(59, 1, "atkagi10",    0,  400, 0, 0, 0, 0.1,   0, 0.1,   0, Attribute.none, 0), // Feline Aspect
        new Array(60, 1, "atkwis10",    0,  400, 0, 0, 0, 0.1,   0,   0, 0.1, Attribute.none, 0), // Simian Aspect
        new Array(61, 1, "defagi10",    0,  400, 0, 0, 0,   0, 0.1, 0.1,   0, Attribute.none, 0), // Avian Aspect
        new Array(62, 1, "defwis10",    0,  400, 0, 0, 0,   0, 0.1,   0, 0.1, Attribute.none, 0), // Chelonian Aspect
        new Array(63, 1, "agiwis10",    0,  400, 0, 0, 0,   0,   0, 0.1, 0.1, Attribute.none, 0), // Vulpine Aspect
        new Array(64, 1, "datk20",      0,  150, 0, 0, 0, -0.2,    0,    0,    0, Attribute.none, 0), // Weakness
        new Array(65, 1, "ddef20",      0,  150, 0, 0, 0,    0, -0.2,    0,    0, Attribute.none, 0), // Lower Defense
        new Array(66, 1, "dagi20",      0,  150, 0, 0, 0,    0,    0, -0.2,    0, Attribute.none, 0), // Slow
        new Array(67, 1, "dagi40",      0, 1000, 0, 0, 0,    0,    0, -0.4,    0, Attribute.none, 0), // Gravity Wave
        new Array(68, 1, "dwis20",      0,  150, 0, 0, 0,    0,    0,    0, -0.2, Attribute.none, 0), // Mind Blast
        new Array(69, 1, "dwis40",      0, 1000, 0, 0, 0,    0,    0,    0, -0.4, Attribute.none, 0), // Psychic Blast
        new Array(70, 2, "heal",        0,  100, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Heal
        new Array(71, 2, "majorheal",   0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Greater Heal
        new Array(72, 2, "life",        0,  450, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Life Drain
        new Array(73, 2, "mana",        0,   20, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Energy Drain
        new Array(74, 2, "ls",          0,    1, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Last Stand
        new Array(75, 2, "sd",          0,    0, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Self-destruct
        new Array(76, 2, "qs",          0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Quick Strike
        new Array(77, 2, "revival",     0,    1, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Revival
        new Array(78, 2, new Array("ep", "pulse"),        0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Ethereal Pulse
        new Array(79, 0, new Array("gs", "smash"),        0, 1200, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Gigant Smash
        new Array(80, 2, "ds",                            0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Deft Step
        new Array(81, 2, "sap",                           0,  600, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0), // Sap
        new Array(82, 2, new Array("fb", "multiblock"),   0,  600, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // Full Barrier (Attribute resistance)
        new Array(83, 2, new Array("mr", "mindbreak"),    0,  600, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // Mind Rift (Confusion)
        new Array(84, 2, new Array("dr", "counter"),      0,  300, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // Deadly Reflex (Counterattack)
        new Array(85, 0, "mecha4",                        0, 1200, 0, 0, 0, 0, 0, 0, 0, Attribute.mecha, 4),     // Phantom Gear (Mecha + 4)
        new Array(86, 0, new Array("bg", "soulslash"), 1000,    0, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // Blood Gambit
        new Array(87, 2, "curse",                         0,    0, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // Mana Martyr (Deals MP damage on death)
        new Array(88, 1, "datk40",                        0, 1000, 0, 0, 0, -0.4, 0, 0, 0, Attribute.none, 0),   // ハードプレッシャー (敵攻撃-40%)
        new Array(89, 2, "cd",                            0, 1400, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // クラッシュドレイン (HP吸収大)
        new Array(90, 2, new Array("pa", "poisonattack"), 0,    0, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0),      // ポイズンアタック (継続ダメージ)
        new Array(91, 2, "sleep",                         0,    0, 0, 0, 0, 0, 0, 0, 0, Attribute.none, 0)       // ディープスリープ (行動不能)
    );
