...
var WhatIsNew = (function() {
    var whatisnew = function() {
        return {
			'2014/12/01': new Array(
				"Added " + Card.mklnk(40403) + ", " + Card.mklnk(40404) + " and " + Card.mklnk(40405) + "."
			),
		    '2014/11/30': new Array(
				"Added " + Card.mklnk(40398) + ", " + Card.mklnk(40399) + ", " + Card.mklnk(40400) + ", " + Card.mklnk(40401) + " and " + Card.mklnk(40402) + "."
			),
			'2014/11/25': new Array(
				"Added Meteor Swarm (fire +4x). Currently mana cost isn't confirmed, just going with what iOS has which is 1300."
			),
		    '2014/11/24': new Array(
				"Added " + Card.mklnk(40389) + ", " + Card.mklnk(40390) + " and " + Card.mklnk(40391) + "."
			),
			'2014/11/18': new Array(
				"Added " + Card.mklnk(40393) + ", " + Card.mklnk(40394) + ", " + Card.mklnk(40395) + ", " + Card.mklnk(40396) + ", " + Card.mklnk(40397) + ", " + Card.mklnk(40371) + ", " + Card.mklnk(40372) + " and " + Card.mklnk(40373) + "."
			),
			'2014/11/10': new Array(
				"Added " + Card.mklnk(40339) + ", " + Card.mklnk(40340) + " and " + Card.mklnk(40341) + "."
			),
			'2014/11/1': new Array(
				"Added " + Card.mklnk(40422) + "."
			),
			'2014/10/26': new Array(
				"Added " + Card.mklnk(40329) + ", " + Card.mklnk(40330) + ", " + Card.mklnk(40331) + " and " + Card.mklnk(40419) + "."
			),
			'2014/10/24': new Array(
				"Added " + Card.mklnk(40237) + ", " + Card.mklnk(40240) + " and " + Card.mklnk(40115) + "."
			),
			'2014/10/17': new Array(
				"Added " + Card.mklnk(40411) + " and " + Card.mklnk(40412) + "."
			),
			'2014/10/16': new Array(
				"Added " + Card.mklnk(40324) + ", " + Card.mklnk(40325) + " and " + Card.mklnk(40326) + "."
			),
			'2014/10/01': new Array(
				"Added " + Card.mklnk(40105) + ", " + Card.mklnk(40392) + ", " + Card.mklnk(40243) + " and " + Card.mklnk(40246) + "."
			),
			'2014/09/20': new Array(
				"Added " + Card.mklnk(40101) + " and " + Card.mklnk(40103) + "."
			),
			'2014/09/18': new Array(
				"Added " + Card.mklnk(40321) + ", " + Card.mklnk(40322) + ", " + Card.mklnk(40323) + ", " + Card.mklnk(40102) + " and " + Card.mklnk(40104) + "."
			),
			'2014/09/02': new Array(
				"Added " + Card.mklnk(40274) + ", " + Card.mklnk(40275) + ", " + Card.mklnk(40276) + ", " + Card.mklnk(40268) + ", " + Card.mklnk(40269) + " and " + Card.mklnk(40270) + "."
			),
			'2014/08/28': new Array(
				"Added " + Card.mklnk(40262) + ", " + Card.mklnk(40263) + ", " + Card.mklnk(40264) + ", " + Card.mklnk(40265) + ", " + Card.mklnk(40266) + ", " + Card.mklnk(40231) + " and " + Card.mklnk(40232) + "."
			),
			'2014/08/25': new Array(
				"Added " + Card.mklnk(40318) + ", " + Card.mklnk(40319) + " and " + Card.mklnk(40320) + "."
			),
			'2014/08/19': new Array(
				"Added " + Card.mklnk(40259) + ", " + Card.mklnk(40260) + " and " + Card.mklnk(40261) + "."
			),
			'2014/08/11': new Array(
				"Added " + Card.mklnk(40249) + ", " + Card.mklnk(40250) + ", " + Card.mklnk(40251) + ", " + Card.mklnk(40256) + ", " + Card.mklnk(40257) + " and " + Card.mklnk(40258) + "."
			),
			'2014/07/28': new Array(
				"Added " + Card.mklnk(40327) + ", " + Card.mklnk(40328) + ", " + Card.mklnk(40234) + ", " + Card.mklnk(40235) + " and " + Card.mklnk(40236) + "."
			),
			'2014/07/22': new Array(
				"Added " + Card.mklnk(40227) + ", " + Card.mklnk(40228) + " and " + Card.mklnk(40229) + "."
			),
			'2014/07/15': new Array(
				"Added " + Card.mklnk(40224) + ", " + Card.mklnk(40225) + ", " + Card.mklnk(40226) + ", " + Card.mklnk(40272) + " and " + Card.mklnk(40273) + "."
			),
			'2014/07/08': new Array(
				"Added " + Card.mklnk(40174) + ", " + Card.mklnk(40175) + " and " + Card.mklnk(40176) + "."
			),
			'2014/06/30': new Array(
				"Added " + Card.mklnk(40217) + ", " + Card.mklnk(40218) + ", " + Card.mklnk(40219) + " and " + Card.mklnk(40220) + "."
			),
			'2014/06/27': new Array(
				"Added " + Card.mklnk(40211) + ", " + Card.mklnk(40212) + ", " + Card.mklnk(40213) + ", " + Card.mklnk(40214) + " and " + Card.mklnk(40215) + "."
			),
			'2014/06/24': new Array(
				"Added " + Card.mklnk(40208) + ", " + Card.mklnk(40209) + ", " + Card.mklnk(40210) + " and " + Card.mklnk(40221) + "."
			),
			'2014/06/17': new Array(
				"Added " + Card.mklnk(40161) + ", " + Card.mklnk(40162) + ", " + Card.mklnk(40163) + " and " + Card.mklnk(40467) + "."
			),
			'2014/06/13': new Array(
				"Added " + Card.mklnk(40197) + ", " + Card.mklnk(40198) + " and " + Card.mklnk(40199) + "."
			),
			'2014/06/04': new Array(
				"Added " + Card.mklnk(40191) + ", " + Card.mklnk(40192) + ", " + Card.mklnk(40193) + ", " + Card.mklnk(40204) + ", " + Card.mklnk(40205) + ", " + Card.mklnk(40206) +" and " + Card.mklnk(40207) + "."
			),
			'2014/05/27': new Array(
				"Added " + Card.mklnk(40177) + ", " + Card.mklnk(40178) + " and " + Card.mklnk(40179) + "."
			),
			'2014/05/26': new Array(
				"Added " + Card.mklnk(40202) + " and " + Card.mklnk(40203) + "."
			),
			'2014/05/20': new Array(
				"Added " + Card.mklnk(40185) + " and " + Card.mklnk(40186) + "."
			),
			'2014/05/13': new Array(
				"Added " + Card.mklnk(40168) + " and " + Card.mklnk(40169) + ". " + "Fixed (Al)Mighty IM skillset."
			),
			'2014/05/09': new Array(
				"Fixed stats for FFV cards (some stats were incorrectly placed)."
			),
			'2014/05/08': new Array(
				"Added " + Card.mklnk(40180) + ", " + Card.mklnk(40181) + ", " + Card.mklnk(40182) + ", " + Card.mklnk(40184) + ", " + Card.mklnk(40194) + ", and " + Card.mklnk(40195) + "."
			),
			'2014/04/29': new Array(
				"Added " + Card.mklnk(40171) + ", " + Card.mklnk(40172) + ", and " + Card.mklnk(40183) + "."
			),
			'2014/04/21': new Array(
				"Added " + Card.mklnk(40164) + " and " + Card.mklnk(40165) + "."
			),
			'2014/04/14': new Array(
				"Added " + Card.mklnk(40153) + " and " + Card.mklnk(40154) + "."
			),
